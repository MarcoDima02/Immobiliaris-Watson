...
const Header = () => {
  ...
  return (
    <header
      className={cn(
        'fixed top-0 left-0 w-full bg-background/90 z-50 transition-all duration-150 p-5',
        scrolled ? 'shadow-md' : ''
      )}
    >
      <nav className="relative container md:mx-auto max-w-3xl lg:max-w-[1400px] flex items-center justify-between h-[38px]">
        {/* Logo */}
              ...
              <li key={link.label}>
                <a
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'text-primary after:content-[""] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-primary font-bold'
